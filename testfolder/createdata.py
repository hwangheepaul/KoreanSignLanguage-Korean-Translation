...
file = np.genfromtxt('only_onemore_angle_fy_6500_20_beforseperate.csv', delimiter=',')
print(file.shape)
number=0
...
np.savetxt('only_onemore_angle_fy_6500_20_beforseperate_2.csv', file, delimiter=',')
